...
const statusValues = ["activo", "inactivo", "suspendido"];
...
export const createSupplierSchema = z.object({
  body: z.object({
    ...
    supplier_type: z
      ...
      .max(50, "El tipo de proveedor no debe exceder loa 50 caracteres"),
    supplier_description: z
      .string()
      .trim()
      .min(
        5,
    ...
    geographic_coverage: z
      ...
      .max(100, "debe no exceder los 100 caracteres"),
    operating_hours: z
      .string()
      .trim()
      .min(5, "El tiempo de operaciones debe tener al menos 5 caracteres")
